...
function updateMotionValuesFromProps(element, next, prev) {
  ...
  for (const key in next) {
    ...
    if (isMotionValue(nextValue)) {
      ...
      if (true) {
        warnOnce(nextValue.version === "10.12.23", `Attempting to mix Framer Motion versions ${nextValue.version} with 10.12.23 may not work as expected.`);
      }
...
//# sourceMappingURL=chunk-ECRJNAAC.js.map
